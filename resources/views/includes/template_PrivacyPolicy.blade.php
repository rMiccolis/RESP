	...
	<div class="modal-dialog">
		...
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" text-align: justify>Privacy Policy</h4>
			</div>
			<div class="modal-body" text-align: justify>
				...
				<div class="iub_content legal_pp">
					...
					<div class="iub_header">
						...
						<h1>
							Privacy Policy di <strong>fsem.di.uniba.it/</strong>
						</h1>

						<p>Questa Applicazione raccoglie alcuni Dati Personali dei propri
							Utenti.</p>
					</div>
					<!-- /header -->
					...
					<div class="one_line_col">
						...
						<p>Serlab Uniba</p>
						<p>
							<b>Indirizzo email del Titolare:</b>
							giuseppe.rossano95.gr@gmail.com
						</p>
					...
					<div class="one_line_col">
						...
						<p>Fra i Dati Personali raccolti da questa Applicazione, in modo
							autonomo o tramite terze parti, ci sono: email, password, nome,
							cognome, immagine e Cookie.</p>
						...
						<p>
							...
							raccolta dei dati stessi.<br> I Dati Personali possono essere
							...
							Applicazione sono obbligatori. Se l’Utente rifiuta di
							...
							sulla disponibilità del Servizio o sulla sua operatività.<br> Gli
							Utenti che dovessero avere dubbi su quali Dati siano obbligatori,
							sono incoraggiati a contattare il Titolare.<br> L’eventuale
							utilizzo di Cookie - o di altri strumenti di tracciamento - da
							parte di questa Applicazione o dei titolari dei servizi terzi
							utilizzati da questa Applicazione, ove non diversamente
						...
						<p>L'Utente si assume la responsabilità dei Dati Personali di
					...
					<div class="one_line_col">
						...
						<h2 id="place_of_processing">Modalità e luogo del trattamento dei
							Dati raccolti</h2>
						...
						<ul>
							<li>l’Utente ha prestato il consenso per una o più finalità
								...
								Personali;</li>
							<li>il trattamento è necessario all'esecuzione di un contratto
								con l’Utente e/o all'esecuzione di misure precontrattuali;</li>
							<li>il trattamento è necessario per adempiere un obbligo legale
								al quale è soggetto il Titolare;</li>
							...
							<li>il trattamento è necessario per il perseguimento del
								legittimo interesse del Titolare o di terzi.</li>
						</ul>
						<p>E’ comunque sempre possibile richiedere al Titolare di chiarire
						...
						<p>
							...
							giuridica del trasferimento di Dati al di fuori dell’Unione
							Europea o ad un’organizzazione internazionale di diritto
							internazionale pubblico o costituita da due o più paesi, come ad
							esempio l’ONU, nonché in merito alle misure di sicurezza adottate
							dal Titolare per proteggere i Dati.<br>
							<br> L’Utente può verificare se abbia luogo uno dei trasferimenti
						...
						<p>Pertanto:</p>
						<ul>
							<li>I Dati Personali raccolti per scopi collegati all’esecuzione
								di un contratto tra il Titolare e l’Utente saranno trattenuti
								sino a quando sia completata l’esecuzione di tale contratto.</li>
							<li>I Dati Personali raccolti per finalità riconducibili
								...
								documento o contattando il Titolare.</li>
						</ul>
						<p>
					...
					<div class="one_line_col">
						...
						<h2 id="use_collected_data">Finalità del Trattamento dei Dati
							raccolti</h2>
					...
					<div class="one_line_col">
						...
						<h2 id="data_processing_detailed_info">Dettagli sul trattamento
							dei Dati Personali</h2>
						...
						<ul class="for_boxes">
							...
							<li>
								<div class="box_primary box_10 expand collapsed">
									<h3 class="expand-click w_icon_24 policyicon_purpose_5638283">Registrazione
										ed autenticazione</h3>
									<div class="expand-content" style="display: none;">

										<p>
											Con la registrazione o l’autenticazione l’Utente consente
											all’Applicazione di identificarlo e di dargli accesso a
											servizi dedicati.<br> A seconda di quanto indicato di
											seguito, i servizi di registrazione e di autenticazione
											potrebbero essere forniti con l’ausilio di terze parti.
											Qualora questo avvenga, questa applicazione potrà accedere ad
											alcuni Dati conservati dal servizio terzo usato per la
											registrazione o l’identificazione.
										</p>
										...
										<div class="wrap">
											<p>Auth0 è un servizio di registrazione ed autenticazione
												fornito da Auth0, Inc. Per semplificare il processo di
												registrazione ed autenticazione, Auth0 può utilizzare
												fornitori di identità di terze parti e salvare le
												informazioni sulla propria piattaforma.</p>
										</div>


										<p>Dati Personali raccolti: cognome, Cookie, email, immagine,
											nome, password e varie tipologie di Dati secondo quanto
						...
						<ul class="for_boxes">
							...
							<li>
								<div class="box_primary box_10 expand expanded">
									<h3 class="expand-click w_icon_24 icon_general">Analisi dei
										Dati dell’Utente e previsioni (“profilazione”)</h3>
									<div class="expand-content" style="display: block;">
										<div class="wrap">
											<p>
												Il Titolare potrebbe trattare i dati d’utilizzo raccolti
												attraverso questa Applicazione per creare o aggiornare
												profili di utenza. Questo tipo di trattamento consente al
												Titolare di valutare scelte, preferenze e comportamento
												dell’Utente per gli scopi specificati nelle rispettive
												sezioni di questo documento.<br> I profili d’utenza possono
												essere creati anche grazie a strumenti automatizzati, come
												algoritmi, che possono anche essere offerti da terze parti.
												Per ottenere ulteriori informazioni sull’attività di
												profilazione l’Utente può fare riferimento alle rispettive
												sezioni di questo documento.<br> L’Utente ha in ogni momento
												diritto ad opporsi a tale attività di profilazione. Per
												scoprire di più sui diritti dell’Utente e su come
												esercitarli, l’Utente può fare riferimento alla sezione di
							...
							<li>
								<div class="box_primary box_10 expand collapsed">
									<h3 class="expand-click w_icon_24 icon_general">Dati Personali
										raccolti attraverso fonti diverse dall'Utente</h3>
									<div class="expand-content" style="display: none;">
										<div class="wrap">
											<p>
												Il Titolare di questa Applicazione potrebbe aver
												legittimamente raccolto Dati Personali relativi all’Utente
												senza il suo coinvolgimento, attingendo a fonti fornite da
												terze parti, in conformità con le basi giuridiche descritte
												nella sezione relativa alle basi giuridiche del trattamento.<br>
												Qualora il Titolare avesse raccolto Dati Personali in tal
												modo, l’Utente potrà trovare informazioni specifiche
												riguardo alle fonti nelle rispettive sezioni di questo
												documento o contattando il Titolare.
											</p>
										</div>
									</div>
									<!-- /expand-content -->
							...
							<li>
								<div class="box_primary box_10 expand collapsed">
									<h3 class="expand-click w_icon_24 icon_general">Identificazione
										univoca del dispositivo</h3>
									<div class="expand-content" style="display: none;">
										<div class="wrap">
											<p>Questa Applicazione può tracciare gli Utenti tramite il
												salvataggio di un codice di identificazione univoco del loro
												dispositivo, per finalità statistiche o per conservare le
												preferenze degli Utenti.</p>
										</div>
									</div>
									<!-- /expand-content -->
								</div> <!-- /expand -->
					...
					<div class="one_line_col">
						...
						<p>Gli Utenti possono esercitare determinati diritti con
							riferimento ai Dati trattati dal Titolare.</p>
						<p>In particolare, l’Utente ha il diritto di:</p>

						<ul>
							<li><b>revocare il consenso in ogni momento.</b> L’Utente può
								revocare il consenso al trattamento dei propri Dati Personali
								precedentemente espresso.</li>
							<li><b>opporsi al trattamento dei propri Dati.</b> L’Utente può
							...
							<li><b>accedere ai propri Dati.</b> L’Utente ha diritto ad
								ottenere informazioni sui Dati trattati dal Titolare, su
								determinati aspetti del trattamento ed a ricevere una copia dei
								Dati trattati.</li>
							<li><b>verificare e chiedere la rettificazione.</b> L’Utente può
								verificare la correttezza dei propri Dati e richiederne
								l’aggiornamento o la correzione.</li>
							<li><b>ottenere la limitazione del trattamento.</b> Quando
								...
								loro conservazione.</li>
							<li><b>ottenere la cancellazione o rimozione dei propri Dati
									Personali.</b> Quando ricorrono determinate condizioni,
								l’Utente può richiedere la cancellazione dei propri Dati da
								parte del Titolare.</li>
							<li><b>ricevere i propri Dati o farli trasferire ad altro
									titolare.</b> L’Utente ha diritto di ricevere i propri Dati in
							...
							<li><b>proporre reclamo.</b> L’Utente può proporre un reclamo
						...
						<p>Quando i Dati Personali sono trattati nell’interesse pubblico,
							...
							Utenti hanno diritto ad opporsi al trattamento per motivi
							connessi alla loro situazione particolare.</p>
						<p>Si fa presente agli Utenti che, ove i loro Dati fossero
					...
					<div class="one_line_col">
						...
						<h2 id="further_data_processing_info">Ulteriori informazioni sul
							trattamento</h2>

						<h3>Difesa in giudizio</h3>
						<p>
							I Dati Personali dell’Utente possono essere utilizzati da parte
							del Titolare in giudizio o nelle fasi preparatorie alla sua
							eventuale instaurazione per la difesa da abusi nell'utilizzo di
							questa Applicazione o dei Servizi connessi da parte dell’Utente.<br>
						...
						<p>Ulteriori informazioni in relazione al trattamento dei Dati
							...
							Titolare del Trattamento utilizzando gli estremi di contatto.</p>
						...
						<p>
							...
							possibile, su questa Applicazione nonché, qualora tecnicamente e
							legalmente fattibile, inviando una notifica agli Utenti
							attraverso uno degli estremi di contatto di cui è in possesso il
							Titolare . Si prega dunque di consultare regolarmente questa
							pagina, facendo riferimento alla data di ultima modifica indicata
							in fondo.<br>
					...
					<!-- /one_line_col -->
							...
							<h3 class="expand-click w_icon_24 icon_ribbon">Definizioni e
								...
								<p>Costituisce dato personale qualunque informazione che,
									...
									una persona fisica.</p>

								<h4>Dati di Utilizzo</h4>
								<p>Sono le informazioni raccolte automaticamente attraverso
									questa Applicazione (anche da applicazioni di parti terze
									integrate in questa Applicazione), tra cui: gli indirizzi IP o
									i nomi a dominio dei computer utilizzati dall’Utente che si
									connette con questa Applicazione, gli indirizzi in notazione
									...
									indicante lo stato della risposta dal server (buon fine,
									errore, ecc.) il paese di provenienza, le caratteristiche del
									browser e del sistema operativo utilizzati dal visitatore, le
									varie connotazioni temporali della visita (ad esempio il tempo
									di permanenza su ciascuna pagina) e i dettagli relativi
								...
								<h4>Utente</h4>
								<p>L'individuo che utilizza questa Applicazione che, salvo ove
								...
								<p>La persona fisica o giuridica, l'autorità pubblica, il
									servizio o altro organismo che, singolarmente o insieme ad
									altri, determina le finalità e i mezzi del trattamento di dati
									personali e gli strumenti adottati, ivi comprese le misure di
									sicurezza relative al funzionamento ed alla fruizione di questa
									Applicazione. Il Titolare del Trattamento, salvo quanto
									diversamente specificato, è il titolare di questa Applicazione.</p>

								<h4>Questa Applicazione</h4>
								<p>Lo strumento hardware o software mediante il quale sono
									raccolti e trattati i Dati Personali degli Utenti.</p>

								<h4>Servizio</h4>
								<p>Il Servizio fornito da questa Applicazione così come definito
									nei relativi termini (se presenti) su questo sito/applicazione.</p>

								<h4>Unione Europea (o UE)</h4>
								<p>Salvo ove diversamente specificato, ogni riferimento
									all’Unione Europea contenuto in questo documento si intende
									esteso a tutti gli attuali stati membri dell’Unione Europea e
									dello Spazio Economico Europeo.</p>

								<h4>Cookie</h4>
								<p>Piccola porzione di dati conservata all'interno del
								...
								<p>La presente informativa privacy è redatta sulla base di
									...
									del Regolamento (UE) 2016/679.</p>
								<p>Ove non diversamente specificato, questa informativa privacy
									riguarda esclusivamente questa Applicazione.</p>
