 ...
 * @package App\Models
 */
class ProcedureBodySite extends Eloquent
{
	protected $table = 'ProcedureBodySite';
	...
	{
		return $this->hasMany(\App\Models\TblProcTerapeutiche::class, 'bodySite');
	}
}
