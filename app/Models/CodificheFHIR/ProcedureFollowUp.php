 ...
 * @package App\Models
 */
class ProcedureFollowUp extends Eloquent
{
	protected $table = 'ProcedureFollowUp';
	...
	{
		return $this->hasMany(\App\Models\TblProcTerapeutiche::class, 'followUp');
	}
}
