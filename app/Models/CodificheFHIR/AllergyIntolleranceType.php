 ...
 * @package App\Models
 */
class AllergyIntolleranceType extends Eloquent
{
	protected $table = 'AllergyIntolleranceType';
	...
	{
		return $this->hasMany(\App\Models\AllergyIntollerance::class, 'tipo');
	}
}
