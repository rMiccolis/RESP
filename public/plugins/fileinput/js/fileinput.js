...
(function ($) {
    ...
    var isIE = function (ver) {
        ...
        defaultFileActionSettings = {
            ...
            indicatorErrorTitle: 'Errore di caricamento',
    ...
    $.fn.fileinput.defaults = {
        ...
        cancelTitle: 'Interrompi l\'upload',
        ...
        maxFileSize: 0,
        maxFileCount: 0,
        msgSizeTooLarge: 'Il file "{name}" (<b>{size} KB</b>) eccede le dimensioni massime consentite di <b>{maxSize} KB</b>.',
        msgFilesTooMany: 'Il numero di file selezionati per l\'upload <b>({n})</b> eccede il limite di <b>{m}</b>.',
        msgFileNotFound: 'File "{name}" non trovato!',
        msgFileSecured: 'Le restrizioni di sicurezza prevengono la lettura del file "{name}".',
        msgFileNotReadable: 'Il file "{name}" non è leggibile.',
        msgFilePreviewAborted: 'Anteprima del file "{name}" interrotta.',
        msgFilePreviewError: 'E\' occorso un errore nella lettura del file "{name}".',
        msgInvalidFileType: 'Tipo non valido per il file "{name}". Solo file di tipo "{types}" sono supportati.',
        msgInvalidFileExtension: 'Estensione invalida per il file "{name}". Solo file con estensioni "{extensions}" sono supportati.',
        msgValidationError: '<span class="text-danger"><i class="glyphicon glyphicon-exclamation-sign"></i> Errore nell\'upload del file</span>',
        msgErrorClass: 'file-error-message',
        msgLoading: 'Caricamento del file {index} di {files} &hellip;',
        msgProgress: 'Caricamento del file {index} di {files} - {name} - {percent}% completato.',
